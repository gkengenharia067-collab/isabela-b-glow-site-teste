...
const HERO_IMG = "/images/hero-bg-2026.jpg";

const WHATSAPP_BASE = "https://wa.me/5567992671108";
const wa = (msg: string) => `${WHATSAPP_BASE}?text=${encodeURIComponent(msg)}`;

// ============================================================
// SERVIÇOS COM LINK DIRETO PARA O SISTEMA DE AGENDAMENTO
// ============================================================
const SISTEMA_BASE = "https://teste-isabela-alpha.vercel.app/catalogo";

type Service = { name: string; link: string; message?: string };
type Tab = { id: string; label: string; intro?: string; items: Service[] };

// Mapeamento dos IDs dos serviços (obtidos do Supabase)
const IDS = {
  Bioestimulador: "bb597162-ee58-4281-8368-f14a1bb88a13",
  "Ultraformer MPT": "175ed00f-5951-4c6f-afb8-919c80c34fc9",
  Botox: "b9472557-e5a5-4162-9690-207069cba68c",
  "Laser Lavieen": "541bbf2f-51e3-4b28-818b-44eedd3e1244",
  "Jato de Plasma": "f5140f99-0427-49c3-90fb-2a54282b9b8d",
  Microagulhamento: "5e47d127-62fa-4e8c-9e14-5d9ae9b918fd",
  "Limpeza de Pele Plus": "d0dd3fb3-0f6a-4159-a2b2-3167f8211d51",
  "Limpeza de Pele": "ad2afec8-820b-49b1-8d27-46a596dc5b80",
  Revitalização: "40cd3c4f-06a3-437c-9085-d8c79a64364e",
  "Drenagem Corporal": "86f0578e-26f5-418f-b073-d5fcb829d0a4",
  "Maquiagem Completa": "a8601af0-9709-462b-b1b7-3af638fd9630",
  "Maquiagem Express": "cc56ac24-3cb2-4c8e-97b7-b9489523c2e8",
  "Revitalização Labial": "18b8dbea-bb9e-4cc6-bed0-59e34da1e9af",
  "Lifting de Cílios": "b885ebf8-7422-49c0-bb1f-5cff1f68d8a5",
  "Design de Sobrancelhas": "33e03d96-4179-4b01-b08d-9da270f1d0f3",
  "Design com Henna / Tintura / Clareamento": "17662f27-8fa5-410c-99b4-fd32c6055b02",
  "Brown Lamination": "0965a5c1-a21f-4f3b-835b-9f1836d26e42",
  Nanopigmentação: "9f370efd-8dc3-4dfe-894b-ef1a1dfb8d1f",
  "Epilação a Cera / Linha": "91e5cf59-58af-48d5-be1c-fc606322608d",
  "Região Pequena (Laser)": "c4740fcc-afb6-4d95-b285-a6dd95c87c26",
  "Região Média (Laser)": "5265e922-451b-42f5-8647-94e9edc9d1c2",
  "Região Grande (Laser)": "faecf82c-2d4b-4b90-ab5f-174bdf476911",
};

// Função para criar o link do sistema para um serviço
const linkSistema = (nome: string) =>
  `${SISTEMA_BASE}/${IDS[nome as keyof typeof IDS]}`;
...
const TABS: Tab[] = [
  ...
  },
  {
    id: "corpo",
    label: "Corpo",
    items: [{ name: "Drenagem Corporal", link: linkSistema("Drenagem Corporal") }],
  },
  {
    id: "maquiagem",
    label: "Maquiagem & Olhos",
    items: [
      { name: "Maquiagem Completa", link: linkSistema("Maquiagem Completa") },
      { name: "Maquiagem Express", link: linkSistema("Maquiagem Express") },
      { name: "Revitalização Labial", link: linkSistema("Revitalização Labial") },
      { name: "Lifting de Cílios", link: linkSistema("Lifting de Cílios") },
    ],
  },
  {
    id: "sobrancelhas",
    label: "Sobrancelhas",
    items: [
      { name: "Design de Sobrancelhas", link: linkSistema("Design de Sobrancelhas") },
      { name: "Design com Henna / Tintura / Clareamento", link: linkSistema("Design com Henna / Tintura / Clareamento") },
      { name: "Brown Lamination", link: linkSistema("Brown Lamination") },
      { name: "Nanopigmentação", link: linkSistema("Nanopigmentação") },
      { name: "Epilação a Cera / Linha", link: linkSistema("Epilação a Cera / Linha") },
    ],
  },
  {
    id: "laser",
    ...
    items: [
      { name: "Região Pequena", link: linkSistema("Região Pequena (Laser)") },
      { name: "Região Média", link: linkSistema("Região Média (Laser)") },
      { name: "Região Grande", link: linkSistema("Região Grande (Laser)") },
    ],
  },
];
